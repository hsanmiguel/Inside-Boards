...
Company: Rectrix
Project: Menti
Feature: [MNT-021] Inside Boards - To Do Screen
Description: This code initializes the To Do screen for managing tasks.
 */
...
class _ToDoScreenState extends State<ToDoScreen> {
  ...
  int _selectedTabIndex = 1; // Default to "To Do"
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Edit To-Do List')));
        },
