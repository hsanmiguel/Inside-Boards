...
Company: Rectrix
Project: Menti
Feature: [MNT-001] Inside Boards - Backlog Options Screen
...
class BacklogOptionsScreen extends StatefulWidget {
  const BacklogOptionsScreen({super.key});

  @override
  State<BacklogOptionsScreen> createState() => _BacklogOptionsScreenState();
}

class _BacklogOptionsScreenState extends State<BacklogOptionsScreen> {
  ...
  void _onTabTap(int index) {
    ...
    switch (index) {
      ...
      case 2:
        destination =
            const ForTesting(); // Replace with actual In Progress screen
        break;
      case 3:
        destination =
            const ForTesting(); // Replace with actual For Testing screen
        break;
      case 4:
        destination = const ForTesting(); // Replace with actual Done screen
        break;
      default:
        destination = const BacklogScreen();
    }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Edit Backlog Options')));
        },
  ...
  Widget _buildTaskCard() {
    String _selectedPriority = "High Priority"; // Default priority
