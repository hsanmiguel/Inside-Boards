...
Company: Rectrix
Project: Menti
Feature: [MNT-001] Inside Boards - For Testing Screen
Description: This code initializes the For Testing screen for managing tasks in the testing phase.
 */
...
class ForTesting extends StatefulWidget {
  const ForTesting({super.key});

  @override
  State<ForTesting> createState() => _ForTestingState();
}

class _ForTestingState extends State<ForTesting> {
  bool _showOptions = false; // Controls visibility of options menu
  int _selectedTabIndex = 3; // Start on "For Testing"
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Edit Testing Tasks')));
        },
