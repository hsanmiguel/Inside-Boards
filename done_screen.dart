...
Company: Rectrix
Project: Menti
Feature: [MNT-] Inside Boards - Done Screen
Description: This code initializes the Done screen for managing completed tasks.
 */
...
import 'package:menti_application/inside_boards/in_progress.dart';
...
class _DoneScreenState extends State<DoneScreen> {
  ...
  int _selectedTabIndex = 4; // Default to "Done"
  ...
  void _onTabTap(int index) {
    ...
    switch (index) {
      case 0:
        destination = const BacklogScreen(); // Replace with Backlog screen
        break;
      case 1:
        destination = const ToDoScreen(); // Replace with To Do screen
        break;
      case 2:
        destination =
            const InProgressScreen(); // Replace with In Progress screen
        break;
      case 3:
        destination = const ForTesting(); // Replace with For Testing screen
        break;
      case 4:
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Edit Done Tasks')));
        },
